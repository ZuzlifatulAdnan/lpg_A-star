...
@section('main')
    <div id="main-content">
        <div class="page-heading">
            <h3>Daftar Pemesanan Diproses</h3>
                ...
                <div class="card-body">
                    <form class="row g-3 mb-4" method="GET">
                        ...
                        <div class="col-md-4">
                            ...
                            <a href="{{ route('pemesanan.proses') }}" class="btn btn-outline-secondary">
                                            ...
                                            <form action="{{ route('pemesanan.updateStatus', $pemesanan->id) }}"
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="modalStatusLabel{{ $pemesanan->id }}">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select name="status" class="form-select" required>
                                                                @foreach (['Diterima', 'Diproses', 'Ditunda'] as $status)
                                                                    <option value="{{ $status }}"
