                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="user_id" id="user_id" class="form-select">
                                    ...
                                    @foreach ($users as $user)
                                        <option value="{{ $user->id }}" {{ $lokasi->user_id == $user->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="jenis_usaha" class="form-select">
                                    ...
                                    <option value="Pangkalan" {{ $lokasi->jenis_usaha == 'Pangkalan' ? 'selected' : '' }}>Pangkalan</option>
                                    <option value="Pengecer" {{ $lokasi->jenis_usaha == 'Pengecer' ? 'selected' : '' }}>Pengecer</option>
                                </select>
                                @error('jenis_usaha')
                                    <div class="text-danger small">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="nama_usaha" class="form-control" value="{{ $lokasi->nama_usaha }}">
                                @error('nama_usaha')
                                    <div class="text-danger small">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="alamat" class="form-control" value="{{ $lokasi->alamat }}">
                                @error('alamat')
                                    <div class="text-danger small">{{ $message }}</div>
                                @enderror
                            </div>
