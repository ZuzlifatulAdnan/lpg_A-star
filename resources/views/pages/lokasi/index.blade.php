            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>Lokasi</h3>
                        <p class="text-subtitle text-muted">Halaman untuk mengelola data lokasi usaha pengguna LPG 3Kg.</p>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center flex-wrap">
                                                    ...
                                                    <a href="{{ route('lokasi.edit', $lokasi) }}"
                                                        class="btn btn-sm btn-success btn-icon m-1" data-bs-toggle="tooltip"
                                                        title="Edit">
                                                    ...
                                                    <form action="{{ route('lokasi.destroy', $lokasi) }}" method="POST"
                                                        ...
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="btn btn-sm btn-danger btn-icon m-1"
                        ...
                        <div class="card-footer d-flex justify-content-between align-items-center flex-wrap mt-3">
                            <span class="text-muted mb-2 mb-md-0">
                                Menampilkan {{ $lokasis->firstItem() }} sampai {{ $lokasis->lastItem() }} dari {{ $lokasis->total() }} entri
                            </span>
                            <nav class="mb-0">
