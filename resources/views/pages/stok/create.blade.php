                                ...
                                <form action="{{ route('stok.store') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="jenis_pemilik" id="jenis_pemilik"
                                            ...
                                            <option value="Admin" {{ old('jenis_pemilik') == 'Admin' ? 'selected' : '' }}>
                                                Admin</option>
                                            <option value="Pangkalan"
                                                {{ old('jenis_pemilik') == 'Pangkalan' ? 'selected' : '' }}>Pangkalan</option>
                                            <option value="Pengecer"
                                                {{ old('jenis_pemilik') == 'Pengecer' ? 'selected' : '' }}>Pengecer</option>
                                        </select>
                                        @error('jenis_pemilik')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="lokasi_id[]" id="lokasi_id"
                                            class="form-control @error('lokasi_id') is-invalid @enderror" multiple required>
