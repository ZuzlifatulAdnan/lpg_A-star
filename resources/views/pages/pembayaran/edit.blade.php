                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('pembayaran.update', $pembayaran->id) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="status" id="status"
                                        ...
                                        <option value="Menunggu Pembayaran"
                                            {{ old('status', $pembayaran->status) == 'Menunggu Pembayaran' ? 'selected' : '' }}>
                                            Menunggu Pembayaran</option>
                                        <option value="Proses Pembayaran"
                                            {{ old('status', $pembayaran->status) == 'Proses Pembayaran' ? 'selected' : '' }}>
                                            Proses Pembayaran</option>
                                        <option value="Pembayaran Berhasil"
                                            {{ old('status', $pembayaran->status) == 'Pembayaran Berhasil' ? 'selected' : '' }}>
                                ...
                                <div id="qris-section" class="mb-3 d-none">
                                    ...
                                    <img src="{{ asset('img/qris-barcode.png') }}" alt="QRIS Barcode"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="jumlah_dibayar" id="jumlah_dibayar"
                                        ...
                                        class="form-control @error('jumlah_dibayar') is-invalid @enderror" readonly
                                        required>
                                    ...
                                    <div class="mt-3">
                                        @if ($pembayaran->bukti_bayar)
                                            ...
                                            <img src="{{ asset('img/bukti_bayar/' . $pembayaran->bukti_bayar) }}"
                                                alt="Bukti Bayar Lama" style="max-width:200px;">
                                        @endif
